...
public class QLNavigationTabView extends FrameLayout {
    ...
    public static class Builder {
         ...
         * 设置tab背景资源
         */
        public Builder setTabBgRes(Drawable focusRes, Drawable normalRes) {
         ...
         * 是否默认选中
         */
        public Builder isSelect(boolean isDefault) {
         ...
         * 设置title 颜色
         */
        public Builder setTitleColor(int normalColor, int focusColor) {
            this.normalColor = normalColor;
            this.focusColor = focusColor;
            return this;
        }
