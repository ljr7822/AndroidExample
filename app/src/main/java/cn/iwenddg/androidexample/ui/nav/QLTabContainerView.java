package cn.iwenddg.androidexample.ui.nav;
...
import cn.iwenddg.androidexample.utils.LifecycleUtils;
import cn.iwenddg.androidexample.utils.MainTabTheme;
import cn.iwenddg.androidexample.utils.UIUtils;
...
public class QLTabContainerView extends LinearLayout implements View.OnClickListener {
    ...
    private final static String[] DEFAULT_LOTTIE_FILES =
            {"tabs/community.json", "tabs/im.json", "tabs/home.json", "tabs/service.json", "tabs/mine.json"};
